	...
	<div id="footerBottomInfoContainer">
		<div class="footerInfo">
			...
			<a href="http://www.facebook.com/pages/The-Malick-Law-Firm/125904747582046">
				<img class="footerSocialImage" src="<?php echo base_url(); ?>comp/img/Facebook.png" width="32" height="33">
			</a>

			<a href="https://twitter.com/AnitaMalick">
				<img class="footerSocialImage" src="<?php echo base_url(); ?>comp/img/Twitter.png" width="32" height="33">
			</a>

			<a href="https://www.youtube.com/channel/UC_DDJ_OoxK6-okWCVuLAQdA?feature=mhee">
				<img class="footerSocialImage" src="<?php echo base_url(); ?>comp/img/YouTube.png" width="32" height="33">
			</a>
		...
		<div class="footerInfo">
			<p class="writeStyleFooterSmall">Phone: 224-235-4924
				</br>Fax: 224-235-4923	
				</br>Cell: 321-662-9893	
			</p>
		</div>
